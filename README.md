...
This repository contains the C++ (CPP) modules completed as part of the curriculum at 1337 School. Each module consists of a series of exercises designed to reinforce and expand my knowledge of C++ programming concepts.
...
- [ex00 - String manipulation and command-line argument handling](./Cpp_Module_00/ex00/)
...
- [ex00 - Classes, Member Functions, Pointers, Memory Allocation (stack vs. heap), Destructors](./Cpp_Module_01/ex00/)
- [ex01 - Arrays of Objects, Memory Allocation (array of objects), Object Initialization](./Cpp_Module_01/ex01/)
- [ex02 - Pointers, References, Memory Addresses](./Cpp_Module_01/ex02/)
- [ex03 - Composition, Aggregation, Object Relationships, Constructors, Setters](./Cpp_Module_01/ex03/)
- [ex04 - File I/O, Content copy to new file, Error Handling](./Cpp_Module_01/ex04/)
...
- [ex00 - Fixed-point numbers, Orthodox Canonical Form](./Cpp_Module_02/ex00/)
- [ex01 - Constructors (from int and float), Member Functions (toFloat, toInt), Operator Overloading](./Cpp_Module_02/ex01/)
- [ex02 - Operator Overloading (Comparison, Arithmetic, Increment/Decrement), Static Member Functions (min, max)](./Cpp_Module_02/ex02/)
- [ex03 - Binary Space Partitioning (BSP), Fixed-point arithmetic, Triangle Point Inclusion Test](./Cpp_Module_02/ex03/)
...
- [ex00 - Class implementation](./Cpp_Module_03/ex00/)
...
- [ex00 - Polymorphism, Inheritance, Virtual Functions](./Cpp_Module_04/ex00/)
...
1. Clone this repository:
    ...
    ```bash
    git clone github.com/M4rgs/CPP_Modules
    ```
